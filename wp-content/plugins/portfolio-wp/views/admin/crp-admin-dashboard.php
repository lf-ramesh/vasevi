...
<div id="crp-dashboard-wrapper">
    <div id="crp-dashboard-add-new-wrapper">
        <div class="crp-upgrade-note crp-fl">You’re running Free version of Gallery. You can <a href="<?php echo CRP_PRO_URL; ?>" class="tooltip" title='<?php echo featuresListToopltip(); ?>'>upgrade</a> your license to unlock all available features.</div>
